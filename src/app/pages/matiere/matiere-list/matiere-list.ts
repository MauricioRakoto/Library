        ...
        <div>
          ...
          <div class="flex items-center gap-2 mt-1">
            ...
            <p class="text-sm font-medium text-gray-500 uppercase tracking-wider">
              {{ matieres.length }} ressources répertoriées
            </p>
          </div>
        </div>
      ...
      <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        @if (matieres.length > 0) {
                  ...
                  <td class="px-8 py-5">
                    <div class="flex justify-end gap-2">
                      ...
                      <a [routerLink]="['/matieres/edit', m.matiere_id]"
                         class="flex items-center gap-1.5 px-3 py-1.5 bg-amber-50 hover:bg-amber-100 text-amber-600 rounded-lg text-xs font-semibold transition-colors border border-amber-100"
                         title="Modifier">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-4 h-4">
                      ...
                      <button (click)="delete(m.matiere_id!)"
                              class="flex items-center gap-1.5 px-3 py-1.5 bg-red-50 hover:bg-red-100 text-red-500 rounded-lg text-xs font-semibold transition-colors border border-red-100"
                              title="Supprimer">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-4 h-4">
          ...
          <div class="flex flex-col items-center justify-center py-20 bg-gray-50/50">
            ...
            <p class="text-gray-500 text-sm mb-6">Commencez par ajouter votre première matière.</p>
            <a routerLink="/matieres/nouveau"
